...
<div class="row">
    ...
    <c:forEach var="list" items="${menus}">
        <td>${list.name }</td>
        <td class="center">${list.menu_price}</td>
        ...
        <td class="center">
            ...
            <a class="btn btn-success" href="<%=request.getContextPath() %>/viewmenu?mid=${list.id}">
                <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                View
            </a>
            <a class="btn btn-info" href="<%=request.getContextPath() %>/updatemenu?mid=${list.id}">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" href="<%=request.getContextPath() %>/deletemenu?mid=${list.id}">
    ...
    <ul class="pagination pagination-centered">
                        <li><a href="<%=request.getContextPath() %>/pagemenu?cpage_menu=${cpage_menu - 1}">Prev</a></li>
                        <li>
                            <a href="<%=request.getContextPath() %>/pagemenu?cpage_menu=1">1</a>
                        </li>
                        <li><a href="#">2</a></li>
                        <li><a href="#">3</a></li>
                        <li><a href="#">4</a></li>
                        <li><a href="<%=request.getContextPath() %>/pagemenu?cpage_menu=${cpage_menu + 1}">Next</a></li>
                    </ul>
                    </div>
                <!-- --------------------- -->
            </div>
