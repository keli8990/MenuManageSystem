    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-star-empty"></i> Restaurant Information</h2>
            ...
            <div class="box-content">
                <!-- put your content here -->
          		...
          		<div class="page-header">
                   <div class="center"> <h1>${restdetails.name }</h1></div>
                      <div class="left">  <h3><small>Location: ${restdetails.location }</small></h3></div>
                ...
                <div class="col-md-3">
                <img src="${restdetails.img}" width = "150px" height="200px" alt="Restaurant Pic">
                </div>
               <div class="col-md-8">
                	<h3>Short description about the ${restdetails.name }</h3>
                	<p>
                		${restdetails.intro }
                		 <br><br><small>Phone: ${restdetails.phone }</small>
                	</p>
              
                	
                	<blockquote>
                	<h3>Others</h3>
                                    <p>${restdetails.situation }</p>
                                    <small>Register Date:${restdetails.date }</small>
                     </blockquote>
                  </div>
                 </div>
