						...
						<div class="box-inner">
							...
							<div class="center">
								<ul class="pagination pagination-centered">
									<li><a
										href="<%=request.getContextPath() %>/pageup?cpage=${cpage - 1}">Prev</a></li>
									<li><a
										href="<%=request.getContextPath()%>/pageup?cpage=1">1</a></li>
									<li><a href="#">2</a></li>
									<li><a href="#">3</a></li>
									<li><a href="#">4</a></li>
									<li><a
										href="<%=request.getContextPath() %>/pageup?cpage=${cpage + 1}">Next</a></li>
								</ul>
							</div>
						</div>
					</div>
