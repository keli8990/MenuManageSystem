            ...
            <div class="box-content">
                <!-- put your content here -->
          		...
          		<div class="page-header">
                   <div class="center"> <h2>${restdetails.name }'s Order</h2></div>
                   <div class="col-md-2">
                   </div>
                   <div class="col-md-10">
                      <div class="left">  <h3><small>Date:${orderdetail.date }</small></h3></div>
                      <div class="left">  <h4><small>User Name:${orderdetail.user_order.name }</small></h4></div>
                    </div>
                </div>
                <div class="row ">
               <div class="col-md-2">
               ...
               <div class="col-md-10">
                	...
                	<p>
                		${orderdetail.items }
                		 <br><br><small>Total Price($): ${orderdetail.price }</small>
                	</p>
                	<h3>Order Comments</h3>
                	<c:forEach var="list_rorder" items="${listordercomm_rest}">
                	
                	<blockquote>
                	<h4>${list_rorder.name }</h4>
                                    <p>${list_rorder.content }</p>
                                    <small>Post User:${list_rorder.ordertocomm.user_order.name } &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Post Date:${list_rorder.date }</small>
                     </blockquote>
                     </c:forEach>
                  </div>
                 </div>
