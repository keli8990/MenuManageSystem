            ...
            <div class="box-content">
                <!-- put your content here -->
          		...
          		<div class="page-header">
                   <div class="center"> <h1>${menudetails.name }</h1></div>
                      <div class="left">  <h3><small>Price: ${menudetails.menu_price }</small></h3></div>
                ...
                <div class="col-md-3">
                <img src="${menudetails.img_menu}" width = "150px" height="200px" alt="Restaurant Pic">
                </div>
               <div class="col-md-8">
                	<h3>Short description about the ${menudetails.name }</h3>
                	<p>
                		${menudetails.menu_desc }
                		 <br><br><small>Order times: ${menudetails.ordernumber }</small>
                	</p>
                  </div>
                 </div>
        <!--/span-->
