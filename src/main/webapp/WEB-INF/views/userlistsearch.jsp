						...
						<div class="box-inner">
							...
							<div class="box-content">
								...
								<table
									...
									<tbody>
										<tr>
											<c:forEach var="list" items="${usernamesearch}">
												<td>${list.name }</td>
												<td class="center">${list.date}</td>
												<td class="center">${list.age }</td>
												<td class="center">${list.phone }</td>

												<td class="center"><a class="btn btn-success"
													href="<%=request.getContextPath() %>/viewuser?uid=${list.id}">
														<i class="glyphicon glyphicon-zoom-in icon-white"></i>
														View
												</a> <a class="btn btn-info"
													href="<%=request.getContextPath() %>/updateuser?uid=${list.id}">
														<i class="glyphicon glyphicon-edit icon-white"></i> Edit
												</a> <a class="btn btn-danger"
													href="<%=request.getContextPath() %>/deleteuser?uid=${list.id}">
							...
							<div class="center">
								<ul class="pagination pagination-centered">
									<li><a
										href="<%=request.getContextPath() %>/pageusersearch?cpage_usear=${cpage_usear - 1}">Prev</a></li>
									<li><a
										href="<%=request.getContextPath()%>/pageusersearch?cpage_usear=1">1</a></li>
									<li><a href="<%=request.getContextPath()%>/pageusersearch?cpage_usear=2">2</a></li>
									<li><a href="<%=request.getContextPath() %>/pageusersearch?cpage_usear=3">3</a></li>
									<li><a href="#">4</a></li>
									<li><a
										href="<%=request.getContextPath() %>/pageusersearch?cpage_usear=${cpage_usear + 1}">Next</a></li>
								</ul>
							</div>
						</div>
					</div>
