    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <ul class="collapse navbar-collapse nav navbar-nav top-menu">
                ...
                <li>
				<table>
					<form class="navbar-search pull-left" action="searchrest" method="post" >
						
							<tr>
								<td><input placeholder="Search By Restnurant Name"
									class="search-query form-control col-md-8" name="restnamesearch"
									type="text"></td>
...
<div>
    <ul class="breadcrumb">
        <li>
            <a href="restslist">Restaurant List</a>
        </li>
        <li>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-star-empty"></i> Update Restaurant Information</h2>
            ...
            <div class="box-content">
                ...
                <form action="${pageContext.request.contextPath}/confirmupdaterest" method="post" class="bl-form bl-formhor" role="form" enctype="multipart/form-data" >
        <ul>
        <div class="form-group">
        	<li class="bl-form-group">
               ...
               <div class="col-sm-6">
                <div class="controls">
                    <input type="text" value="${restdetails.name }" name="name" class="form-control" required data-msg-required="Please input restaurant's name"/>
                </div>
                </div>
            </li>
        	</div>
            ...
            <li class="bl-form-group">
                ...
                <div class="col-sm-6">
                <div class="controls">
                    <input type="tel" value="${restdetails.phone }" name="phone" class="form-control"  pattern="0[0-9]{9}" required />
                </div>
                </div>
            </li>
           </div>
            <div class="form-group">
            <li class="bl-form-group">
                 <label for="name" class="col-sm-4 control-label"><em>*&nbsp</em>Location: </label>
                 <div class="col-sm-6">
                <div class="controls">
                    <input type="text" value="${restdetails.location }" name="location" class="form-control" required />
                </div>
                </div>
            </li>
            </div>
             ...
             <div class="form-group">
            <li class="bl-form-group">
                 <label for="name" class="col-sm-4 control-label">Restaurant description:</label>
                 <div class="col-sm-6">
                <div class="controls editor">
                    <textarea name="description"  rows="6" class="form-control">${restdetails.intro }</textarea>
                </div>
                </div>
            </li>
            </div>
            <div class="form-group">
            <li class="bl-form-group">
                 <label for="name" class="col-sm-4 control-label">Restaurant others:</label>
                 <div class="col-sm-6">
                <div class="controls editor">
                    <textarea name="otherinfo"  rows="6" class="form-control">${restdetails.situation }</textarea>
                </div>
                </div>
            </li>
            </div>
